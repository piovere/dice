...
from dice.utils import flash_errors, render_extensions
from dice.forms.user import PasswordForm, EmailForm, UsernameForm
from dice.extensions import mail
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        from dice.settings import Config
